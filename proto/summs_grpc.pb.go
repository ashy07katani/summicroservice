...
func (c *sumServiceClient) DoSum(ctx context.Context, in *SumRequest, opts ...grpc.CallOption) (*SumResponse, error) {
	out := new(SumResponse)
	err := c.cc.Invoke(ctx, "/summicroservice.SumService/doSum", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedSumServiceServer) DoSum(context.Context, *SumRequest) (*SumResponse, error) {
...
func _SumService_DoSum_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SumRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SumServiceServer).DoSum(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/summicroservice.SumService/doSum",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SumServiceServer).DoSum(ctx, req.(*SumRequest))
	}
...
var SumService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "summicroservice.SumService",
	HandlerType: (*SumServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "doSum",
			Handler:    _SumService_DoSum_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "proto/summs.proto",
}
